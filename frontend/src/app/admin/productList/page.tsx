  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-semibold pl-8 sm:pl-0">Productos</h1>
      ...
      <div className='space-y-4 pt-8'>
        <ul className="flex flex-wrap text-sm font-medium text-center border-b border-gray-200">
          <li>
            <a aria-current="page" className="inline-block p-2 active border-b-2 text-secondary border-secondary bg-gray-100">
              Todos los Productos
            </a>
          </li>
        </ul>
